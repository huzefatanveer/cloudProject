...
const SideBox = (props) => {
  return (
    <div className="bg-blue-800 max-h-screen h-screen justify-center">
      <div className="">
        <div className="w-100 flex justify-center">
          <div className={props.imageClass}>
            <img
              src={require(`./../../img/${props.image}`)}
              style={{ width: "100%", height: "100%", marginTop:"10px",borderRadius:'5px', opacity:'10px' }}
              alt="Login"
            />
          </div>
        </div>
      ...
      <p className="footer_text text-center text-white mt-20">
        Powered by Zaah Toll
      </p>
    </div>
  );
};
